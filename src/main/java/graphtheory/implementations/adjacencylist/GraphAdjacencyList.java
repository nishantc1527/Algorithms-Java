...
public interface GraphAdjacencyList<E> {
  ...
  /**
   * Connects two vertices together. If it is a weighted graph, specify the weight in an array form,
   * where the weight of the edge would be the sum of all weights in the array.
   *
