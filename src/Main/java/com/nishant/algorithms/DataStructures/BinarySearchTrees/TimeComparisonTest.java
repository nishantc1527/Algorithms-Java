...
import com.nishant.algorithms.DataStructures.BinarySearchTrees.RedBlackTree.RedBlackTree;
...
public class TimeComparisonTest {
    public static void main(String[] args) {
        ...
        System.out.printf("%-40s %d values: %-5d milliseconds\n", "Red Black Tree insertion time for", n,
                ((rbTimeFinish - rbTimeStart) / 1000000));
        System.out.printf("%-40s %d values: %-5d milliseconds\n", "AVL Tree insertion time for", n,
                ((avlTimeFinish - avlTimeStart) / 1000000));
        System.out.printf("%-40s %d values: %-5d milliseconds\n", "Binary Search Tree insertion time for", n,
        ...
        System.out.printf("%-40s %d values: %-5d milliseconds\n", "Red Black Tree search time for", searchN,
                ((rbTimeFinish - rbTimeStart) / 1000000));
        System.out.printf("%-40s %d values: %-5d milliseconds\n", "AVL Tree search time for", searchN,
                ((avlTimeFinish - avlTimeStart) / 1000000));
        System.out.printf("%-40s %d values: %-5d milliseconds\n", "Binary Search Tree search time for", searchN,
                ((bstTimeFinish - bstTimeStart) / 1000000));
        ...
        System.out.printf("%-40s %d values: %-5d milliseconds\n", "Red Black Tree deletion time for", n,
                ((rbTimeFinish - rbTimeStart) / 1000000));
        System.out.printf("%-40s %d values: %-5d milliseconds\n", "AVL Tree deletion time for", n,
                ((avlTimeFinish - avlTimeStart) / 1000000));
