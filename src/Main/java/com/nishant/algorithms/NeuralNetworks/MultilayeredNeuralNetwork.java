...
public class MultilayeredNeuralNetwork {
    ...
    public MultilayeredNeuralNetwork(int inputs, int outputs, double learningRate, int... hiddenLayers) {
    ...
    public void train(double[] inputArr, double[] targetArr) {
        Matrix inputs = Matrix.colMatrixFromArray(inputArr), targets = Matrix.colMatrixFromArray(targetArr);
