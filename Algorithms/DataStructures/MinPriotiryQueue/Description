A Min Priority Queue is a form of a data structure that can easily find the smallest element added so far, remove the smallest element, and decrease the value
